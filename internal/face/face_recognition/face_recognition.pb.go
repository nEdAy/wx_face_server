...
func (*GetFaceCountRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_face_recognition_3ef3a00d0350d0a1, []int{0}
}
...
func (*GetFaceCountReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_face_recognition_3ef3a00d0350d0a1, []int{1}
}
...
func (m *GetFaceCountReply) GetCount() string {
	if m != nil {
		return m.Count
	}
	return ""
...
func (*IsMatchFaceRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_face_recognition_3ef3a00d0350d0a1, []int{2}
}
...
func (*IsMatchFaceReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_face_recognition_3ef3a00d0350d0a1, []int{3}
}
...
func init() {
	proto.RegisterType((*GetFaceCountRequest)(nil), "face.GetFaceCountRequest")
	proto.RegisterType((*GetFaceCountReply)(nil), "face.GetFaceCountReply")
	proto.RegisterType((*IsMatchFaceRequest)(nil), "face.IsMatchFaceRequest")
	proto.RegisterType((*IsMatchFaceReply)(nil), "face.IsMatchFaceReply")
}
...
func (c *faceRecognitionClient) GetFaceCount(ctx context.Context, in *GetFaceCountRequest, opts ...grpc.CallOption) (*GetFaceCountReply, error) {
	...
	err := c.cc.Invoke(ctx, "/face.FaceRecognition/GetFaceCount", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *faceRecognitionClient) IsMatchFace(ctx context.Context, in *IsMatchFaceRequest, opts ...grpc.CallOption) (*IsMatchFaceReply, error) {
	...
	err := c.cc.Invoke(ctx, "/face.FaceRecognition/IsMatchFace", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _FaceRecognition_GetFaceCount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/face.FaceRecognition/GetFaceCount",
	}
...
func _FaceRecognition_IsMatchFace_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/face.FaceRecognition/IsMatchFace",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _FaceRecognition_serviceDesc = grpc.ServiceDesc{
	ServiceName: "face.FaceRecognition",
...
func init() {
	proto.RegisterFile("face.proto", fileDescriptor_face_recognition_3ef3a00d0350d0a1)
}

var fileDescriptor_face_recognition_3ef3a00d0350d0a1 = []byte{
	...
	,
}
